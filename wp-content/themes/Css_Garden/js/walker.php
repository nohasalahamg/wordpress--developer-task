...
class your_themename_top_menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$class_names = $value = 'designer-name';
		...
		if ( $args->has_children && $depth === 0 ) {
			...
			// $atts['data-toggle']   = 'dropdown';
			 $atts['class']         = 'design-name';
			// $atts['aria-haspopup'] = 'true';
		} else {
			$atts['href'] = ! empty( $item->url ) ? $item->url : '';
			$atts['class']         = 'designer-name';
		}
	...
	//	$item_output .= ( $args->has_children && 0 === $depth ) ? '<a class="design-name">' : '<a class="designer-name" >'; 
 ...
 * Description: A custom WordPress nav walker class to implement UIkit menu markup
 */
class your_themename_resource_menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( $atts['class'] =='next')
		{
			$item_output .= '<a'. $attributes .'>'.'<span class="indicator">&rsaquo;</span>';
		}
		$item_output .= '<a'. $attributes .'>';
		$item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
		$item_output .= ( $args->has_children && 0 === $depth ) ? '</a>' : '</a>';
